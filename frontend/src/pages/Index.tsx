...
const Index = () => {
	...
	const handleAssessmentComplete = (
		...
		if (recommendedIds && recommendedIds.length > 0) {
			...
			const matchedExercises = allAvailable.filter((ex) =>
		...
		<div className='min-h-screen gradient-hero'>
			...
			<nav className='fixed top-0 left-0 right-0 z-40 bg-background/80 backdrop-blur-md border-b border-border'>
              ...
              <Activity className="w-5 h-5 text-primary-foreground" />
						...
						<img className='w-[70px]' src='/image.png' alt='' />
							...
							<div className='grid lg:grid-cols-2 gap-12 items-center w-full'>
								<div className='space-y-8 animate-slide-up'>
									...
									<p className='text-lg text-muted-foreground max-w-lg'>
										Get personalized exercise recommendations based on your
										symptoms. Our AI tracks your form in real-time to ensure
											...
											<div className='flex flex-row text-center relative'>
												...
												<div className='flex-1'>
													<img
														...
														alt='shoulder-pain w-full'
														className='h-full'
													/>
												</div>
												<div className='flex-1'>
													<img
														src='elbow-touches.gif'
														alt='elbow-touches w-full'
														className='h-full'
													/>
												</div>
											</div>
